...
file.qmd
↓ edit
file.qmd.tmp # If OneDrive synchrnoises in the meantime, it believes that the file had been discarded
↓ rename
file.qmd
...
![Each tool used to have its perimeter, hence the diversity of Python execs](python-development-layers.png)

![The three levels of Python environments, from system-wide (not to be modified) to the project level](python-dependencies-use-cases.png)
![Side-by-side compariosn of the core use cases of each Python tool -> `uv` supersedes them all!!](python-managers-summary-table.png)
