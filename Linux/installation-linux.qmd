...
ii. Export `keybindings.json` into your local folder: `~/.config/Cursor/User/keybindings.json`
...
4. The whole list of extensions, and Cursor settings are available under the [Cursor config folder](../Config/.cursor/).

> More details are provide in [*Sync Cursor Settings the Dotfiles Way* website](https://dev.to/0916dhkim/sync-cursor-settings-the-dotfiles-way-20c9), including the symlink commands tu fully automate this process

> The harcore way, for syncing configuration files across numerous users, cf Benjamin, and [Cursor Config Sync](https://open-vsx.org/extension/KushalCodes/cursor-config-sync)
