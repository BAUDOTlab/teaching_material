...
groups. More detail is available in the [Server Management
tutorial](../Server%20Management/Server_Management.pdf).
:::
...
As soon as collaboration is involved, follow these project tips:

-   Initialise `git` and GitHub at the real start of the project.
-   Keep work under `/mnt/<cluster-name>/projects/` only (nothing
    long-lived in your home directory except quick tests).
-   When creating the project, set group and user permissions carefully,
    following the guidelines in
    [Server_Management.pdf](https://github.com/BAUDOTlab/teaching_material/blob/main/Server%20Management/Server_Management.pdf),
    section **Creating a New Project**.
-   Maintain a `README.md` at the root of the projects tree with one
    short line per directory summarising the study’s overarching
    objective.
